...
public class StatusesAPI extends AbsOpenAPI {
     ...
     */
    private static final int READ_API_HOME_TIMELINE       = 0;
    private static final int READ_API_USER_TIMELINE       = 1;
    private static final int READ_API_REPOST_TIMELINE     = 2;
    private static final int READ_API_REPOST_IDS          = 3;
    private static final int READ_API_MENTIONS            = 4;
    private static final int READ_API_SHOW                = 5;
    ...
    static {
        sAPIList.put(READ_API_HOME_TIMELINE,      API_BASE_URL + "/home_timeline.json");
        sAPIList.put(READ_API_USER_TIMELINE,      API_BASE_URL + "/user_timeline.json");
        sAPIList.put(READ_API_REPOST_TIMELINE,    API_BASE_URL + "/repost_timeline.json");
        sAPIList.put(READ_API_REPOST_IDS,         API_BASE_URL + "/repost_timeline/ids.json");
    ...
    public void homeTimeline(long since_id, long max_id, int count, int page, boolean base_app,
        ...
        requestAsync(sAPIList.get(READ_API_HOME_TIMELINE), params, HTTPMETHOD_GET, listener);
    }
    ...
    public void repostTimeline(long id, long since_id, long max_id, int count, int page,
        ...
        WeiboParameters params =
                buildRepostTimeLineParamsBase(id, since_id, max_id, count, page, authorType);
        requestAsync(sAPIList.get(READ_API_REPOST_TIMELINE), params, HTTPMETHOD_GET, listener);
    }
    ...
    public void publicTimeline(int count, int page, boolean base_app, RequestListener listener) {
        ...
        requestAsync(sAPIList.get(READ_API_PUBLIC_TIMELINE), params, HTTPMETHOD_GET, listener);
    }

    public void bilateralTimeline(long since_id, long max_id, int count, int page, boolean base_app,
                             int featureType, boolean trim_user, RequestListener listener) {
        WeiboParameters params =
                buildHomeTimeLineParamsBase(since_id, max_id, count, page, base_app, featureType, trim_user);
        requestAsync(sAPIList.get(READ_API_BILATERAL_TIMELINE), params, HTTPMETHOD_GET, listener);
    }
    ...
    public void mentions(long since_id, long max_id, int count, int page, int authorType, int sourceType,
        ...
        WeiboParameters params = buildMentionsParams(since_id, max_id, count, page, authorType, sourceType, filterType);
    ...
    public void count(String ids, RequestListener listener) {
        WeiboParameters params = buildShowParams(ids);
        requestAsync(sAPIList.get(READ_API_COUNT), params, HTTPMETHOD_GET, listener);
    }
    ...
    /**
     * @see #homeTimeline(long, long, int, int, boolean, int, boolean, RequestListener)
     */
    public String homeTimelineSync(long since_id, long max_id, int count, int page, boolean base_app, int featureType,
                                      boolean trim_user) {
        WeiboParameters params = buildHomeTimeLineParamsBase(since_id, max_id, count, page, base_app,
                featureType, trim_user);
    ...
    public String userTimelineSync(long uid, String screen_name, long since_id, long max_id, int count, int page, boolean base_app, int featureType,
        ...
        return requestSync(sAPIList.get(READ_API_USER_TIMELINE), params, HTTPMETHOD_GET);
    }

    public String repostTimeline(long id, long since_id, long max_id, int count,
                                 int page, int authorType) {
        WeiboParameters params =
                buildRepostTimeLineParamsBase(id, since_id, max_id, count, page, authorType);
        return requestSync(sAPIList.get(READ_API_REPOST_TIMELINE), params, HTTPMETHOD_GET);
    }
    ...
    /**
     * @see #mentions(long, long, int, int, int, int, int, RequestListener)
     */
    ...
    // 组装TimeLines的参数
    private WeiboParameters buildHomeTimeLineParamsBase(long since_id, long max_id, int count, int page,
    ...
    private WeiboParameters buildRepostTimeLineParamsBase(long id, long since_id, long max_id, int count,
                                                          int page, int authorType) {
        WeiboParameters params = new WeiboParameters(mAppKey);
        params.put("id", id);
        params.put("since_id", since_id);
    ...
    private WeiboParameters buildPublicTimeLineParamsBase(int count, int page, boolean base_app) {
        WeiboParameters params = new WeiboParameters(mAppKey);
        params.put("count", count);
        params.put("page", page);
        params.put("base_app", base_app ? 1 : 0);
