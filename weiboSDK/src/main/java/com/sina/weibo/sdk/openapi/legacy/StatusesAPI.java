...
public class StatusesAPI extends AbsOpenAPI {
    ...
    private static final int READ_API_MENTIONS         = 3;
    private static final int READ_API_SHOW             = 4;
    private static final int READ_API_COUNT            = 5;
    ...
    public void homeTimeline(long since_id, long max_id, int count, int page, boolean base_app,
        ...
        WeiboParameters params =
                buildHomeTimeLineParamsBase(since_id, max_id, count, page, base_app, trim_user, featureType);
