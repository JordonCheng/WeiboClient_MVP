...
//        status.geo              = Geo.parse(jsonObject.optJSONObject("geo"));
        ...
        status.geo_ori = GeoOri.parse(jsonObject.optJSONObject("geo"));

        JSONArray annotationArray = jsonObject.optJSONArray("annotations");
        status.annotation = Annotation.parse(annotationArray);
