 ...
 * @since 2013-11-04
 */
public class LoginoutButton extends android.support.v7.widget.AppCompatButton implements OnClickListener {
     ...
     */
    public void setWeiboAuthInfo(AuthInfo authInfo, WbAuthListener authListener) {
		mAuthInfo = authInfo;
     ...
     * @param authListener 微博授权认证回调接口
     */
    public void setWeiboAuthInfo(String appKey, String redirectUrl, String scope, WbAuthListener authListener) {
     ...
     * 
     * @param listener AppCompatButton 点击时的 Listener
     */    
			...
			mSsoHandler.authorize(new WbAuthListener() {
				...
				public void onSuccess(Oauth2AccessToken oauth2AccessToken) {
					...
					if (mAuthListener != null) {
						mAuthListener.onSuccess(oauth2AccessToken);
					}
				}
				...
				public void onFailure(WbConnectErrorMessage wbConnectErrorMessage) {
					if (mAuthListener != null) {
						mAuthListener.onFailure(wbConnectErrorMessage);
					}
				}
			});
		} else {
